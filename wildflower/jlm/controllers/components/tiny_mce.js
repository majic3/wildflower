$.jlm.addComponent('tinyMce', {
	...
	getConfig: function() {
		...
		return {
			...
			plugins: "wildflower,bramus_cssextras,noneditable,safari,style,paste,directionality,visualchars,nonbreaking,xhtmlxtras,inlinepopups,fullscreen,wordcount",
			doctype: '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">',

			// Theme options
			theme_advanced_buttons1: "undo,redo,copy,paste,|,bold,italic,strikethrough,|,formatselect,|,bullist,numlist,|,outdent,indent,blockquote,|,wfmedia,wflinks,wfmodules,wfinsertasset,|,charmap,code,fullscreen,|,bramus_cssextras_classes,bramus_cssextras_ids",
			...
			/* advanced image scale is nice but not fully working */
			...
			convert_urls: false,
			/*majic3 set this to true - ow trying false*/
