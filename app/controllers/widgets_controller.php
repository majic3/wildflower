...
class WidgetsController extends AppController {
    ...
    function wf_list_eblocks() {
		Configure::write('debug', 2);
		
        // get eblocks - the view sets up preview links for eblocks the other link inserts the block
		$eblocks = ClassRegistry::init('Block')->find('all');
		$this->set(compact('eblocks'));
    }
