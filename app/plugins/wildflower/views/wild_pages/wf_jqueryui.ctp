	<h2 class="top">Welcome to jQuery UI!</h2>
	<div id="jqueryui">
		<?php	echo $html->image('jQuery_logo_color_onwhite.png'), '<br />', $html->image('jQuery__UI_logo_color_onwhite.png');	?>
	</div>
	<p style="font-size: 1.3em; line-height: 1.5; margin: 1em 0; width: 50%;">This page demonstrates the widgets you downloaded using the theme you selected in the download builder. We've included and linked to minified versions of <a href="js/jquery-1.3.2.min.js">jQuery</a>, your personalized copy of <a href="js/jquery-ui-1.7.custom.min.js">jQuery UI (js/jquery-ui-1.7.custom.min.js)</a>, and <a href="css/smoothness/jquery-ui-1.7.custom.css">css/smoothness/jquery-ui-1.7.custom.css</a> which imports the entire jQuery UI CSS Framework. You can choose to link a subset of the CSS Framework depending on your needs. </p>
